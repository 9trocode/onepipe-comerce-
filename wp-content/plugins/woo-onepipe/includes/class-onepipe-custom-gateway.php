...
class Tbz_WC_onepipe_Custom_Gateway extends Tbz_WC_Gateway_onepipe_Subscription {
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled' => array(
				...
				'label'       => 'Enable onepipe - ' . $this->title,
				'type'        => 'checkbox',
			...
			'payment_channels' 	  => array(
				...
				'type'    		=> 'multiselect',
				'class'  		=> 'wc-enhanced-select wc-onepipe-payment-channels',
			...
			'cards_allowed' => array(
				...
				'type'    		=> 'multiselect',
				'class'  		=> 'wc-enhanced-select wc-onepipe-cards-allowed',
			...
			'banks_allowed' => array(
				...
				'type'    		=> 'multiselect',
				'class'  		=> 'wc-enhanced-select wc-onepipe-banks-allowed',
			...
			'payment_icons' => array(
				'title'     	=> 'Payment Icons',
				'type'    		=> 'multiselect',
				'class'  		=> 'wc-enhanced-select wc-onepipe-payment-icons',
    ...
    */
    public function admin_options() {
    	...
    	<h2>Onepipe - <?php echo $this->title; ?>
		<?php
        ...
        <p>To configure your onepipe API keys and enable/disable test mode, do that <a href="<?php echo get_bloginfo('wpurl') ?>/wp-admin/admin.php?page=wc-settings&tab=checkout&section=onepipe">here</a></p>
    ...
    */
    public function payment_icons() {
	    ...
	    return array(
		    ...
		    'visa'          => 'Visa',
		    'mastercard'    => 'Mastercard',
		    'onepipewhite' => 'Secured by onepipe White',
		    'onepipeblue'  => 'Secured by onepipe Blue',
		    'onepipe-wc'   => 'onepipe',
		    'access'        => 'Access Bank',
		    'alat'          => 'ALAT by WEMA',
